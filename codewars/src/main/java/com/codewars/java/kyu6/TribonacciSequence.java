...
public class TribonacciSequence {
    ...
    public static double[] tribonacci(double[] s, int n) {
        ...
        if (s.length < 3) {
            throw new IllegalArgumentException("Input array length must be > 3");
        }
    ...
    public void sampleTests() {
        ...
        assertArrayEquals(new double []{0,0,1,1,2,4,7,13,24,44}, tribonacci(new double []{0,0,1},2), precision);
