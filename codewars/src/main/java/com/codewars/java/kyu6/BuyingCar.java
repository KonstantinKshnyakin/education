 ...
 * <p>
 * A man has a rather old car being worth $2000. He saw a secondhand car being worth $8000. He wants to keep his
 ...
 * Furthermore this percent of loss increases of 0.5 percent at the end of every two months. Our man finds it difficult
 ...
 * month but if, by chance from the start, the value of the old car is bigger than the value of the new one or equal
 * there is no saving to be made, no need to wait so he can at the beginning of the month buy the new car:
 * <p>
...
public class BuyingCar {
    ...
    public static int[] nbMonths(int startPriceOld, int startPriceNew, int savingperMonth, double percentLossByMonth) {
        ...
        while (sum + priceOld < priceNew) {
            sum += savingperMonth;
            priceOld -= percentLossByMonth * priceOld / 100;
            priceNew -= percentLossByMonth * priceNew / 100;
            if (countMonth % 2 == 0) {
        ...
        return new int[]{countMonth, (int) Math.round(sum + priceOld - priceNew)};
    }
