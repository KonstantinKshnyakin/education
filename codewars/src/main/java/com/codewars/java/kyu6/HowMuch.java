...
/**
 * I always thought that my old friend John was rather richer than he looked, but I never knew exactly how much money
...
public class HowMuch {
    ...
    public static String howmuch(int m, int n) {
        ...
        for (int i = m; i <= n; i++) {
            if (i % 7 == 2) {
                if (i % 9 == 1) {
                    result.add("[M: %d B: %d C: %d]".formatted(i, i / 7, i / 9));
                }
            }
        }
