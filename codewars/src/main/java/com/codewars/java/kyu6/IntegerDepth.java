 ...
 * of 42 to get all the digits. So the depth of 42 is 9. Write a function named computeDepth which computes the depth
 * of its integer argument.Only positive numbers greater than zero will be passed as an input.
 */
public class IntegerDepth {
    ...
    public void sampleTest1() {
        assertEquals(10, computeDepth(1));
    }

    @Test
    public void sampleTest2() {
        assertEquals(5, computeDepth(318));
